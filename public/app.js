...
$(document).on("click", "p", function() {
  ...
  $.ajax({
    ...
    .then(function(data) {
      ...
      $("#notes").append("<br>" + "<button data-id='" + data._id + "' id='savenote'>Save Comment</button>" + "   " + "<button deletedata-id='" + data._id + "' id='deletenote'>Delete</button>");
