...
app.get("/scrape", function(req, res) {
  ...
  axios.get("https://www.entrepreneur.com/topic/cars").then(function(response) {
...
app.post("/articledelete/:id", function(req, res) { 
  // Create a new note and pass the req.body to the entry
  db.Note.remove(req.body)
    .then(function(dbNote) {      
      return db.Article.remove({ _id: req.params.id }, { note: dbNote._id }, { new: false });
    })
